...
CREATE TABLE IF NOT EXISTS `stok_opname_sessions` (
  ...
  `adj_account_id`  INT NOT NULL COMMENT 'Akun penyeimbang untuk selisih kurang (Beban)',
  `income_account_id` INT NULL COMMENT 'Akun penyeimbang untuk selisih lebih (Pendapatan)',
