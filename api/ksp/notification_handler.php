...
try {
    ...
    $pending_pinjaman = stmt_fetch_assoc($stmt_pinjaman)['total'];
    $stmt_pinjaman->close();
    ...
    $details_pinjaman = stmt_fetch_all($stmt_pinjaman_det);
    ...
    $pending_penarikan = stmt_fetch_assoc($stmt_penarikan)['total'];
    ...
    $details_penarikan = stmt_fetch_all($stmt_penarikan_det);
