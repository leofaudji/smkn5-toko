...
$router->get('/audit-transaksi', 'pages/audit_transaksi.php', ['auth']);
...
$router->get('/api/audit-transaksi', 'api/audit_transaksi_handler.php', ['auth']);
$router->post('/api/audit-transaksi', 'api/audit_transaksi_handler.php', ['auth']);
